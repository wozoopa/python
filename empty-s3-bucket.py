...
bucket_name = input(f"\nProvide bucket name to empty --> ")
def empty_s3_bucket(profileName):
    ...
    response = input(f"WARNING: This action cannot be undone. Are you sure you want to delete the following bucket {bucket_name} and ALL of its contents? (y/n) ")
    if response.lower() != "y":
        print("Aborting.")
        exit()
