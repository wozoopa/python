...
pattern = input("\nProvide partial role name--> ")
print(f"ROLE_NAME;ROLE_ARN;ROLE_ID;ACCOUNT_NAME;ACCOUNT_NR;TRUST_POLICY")
        ...
        for page in page_iterator:
            for role in page['Roles']:
                ...
                if re.search(pattern, roleName, re.IGNORECASE):
                    print(f"{roleName};{roleArn};{roleId};{accountName};{accountNr};{trustPolicy}")
