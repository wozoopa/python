...
def list_iam_roles_with_access_details(profileName):
    ...
    try:
        ...
        accountName = "ERROR-UNABLE-TO-GET-ACCOUNT-NAME"

    report_file = (f"/tmp/{today_filename}.{accountName}.AllIamRoles.LastAccessDetails.serviceLevel.csv")
...
if __name__ == "__main__":
    ...
    for p in profile_list:
      ...
      list_iam_roles_with_access_details(profileName)